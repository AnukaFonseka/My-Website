...
const Navbar = () => {
  ...
  return (
    ...
    ">
      ...
      {/* Mobile social icons and theme switcher - visible on mobile at top right */}
      <nav className="hidden lg:flex items-center justify-center">
        <motion.a
          target={"_blank"}
          className="w-5 mx-2 sm:mx-1"
        ...
        <motion.a
          target={"_blank"}
          className="w-5 mx-2 sm:mx-1"
          href="http://www.linkedin.com/in/anukafonseka"
          whileHover={{ y: -2 }}
          whileTap={{ scale: 0.9 }}
        ...
        <button
          ...
          className={`w-5 h-5 ease ml-2 sm:ml-1 flex items-center justify-center rounded-full p-1  
