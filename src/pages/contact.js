...
export default function Contact() {
  return (
    <>
      <Head>
        <title>Contact me - Anuka Fonseka</title>
        <meta name="description" content="Get in touch with Anuka Fonseka — Software Engineer." />
      </Head>
          ...
          <div className="flex flex-col items-center text-center max-w-2xl mx-auto">
            ...
            >
              <ContactCard
                icon={<EmailIcon />}
                label="Email"
                value="akunafonseka@gmail.com"
                href="mailto:akunafonseka@gmail.com"
              />
              <ContactCard
                icon={<PhoneIcon />}
                label="Phone"
                value="+94 76 072 3331"
